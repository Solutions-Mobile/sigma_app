    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "data-[state=checked]:translate-x-[calc(100%-1px)] data-[state=unchecked]:translate-x-px ",
          "data-[state=checked]:bg-(--primary-foreground) data-[state=unchecked]:bg-(--sidebar)"
        )}
      />
    </SwitchPrimitive.Root>
  )
